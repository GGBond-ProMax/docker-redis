...
DATA_REDIS="$REDIS_DATDADIR/data"  # data路径
CONF_REDIS="$REDIS_DATDADIR/conf"  # 配置文件路径
LOG_REDIS="$REDIS_DATDADIR/logs"   # 日志路径
...
sudo docker cp temp-redis:/etc/redis/redis.conf $CONF_REDIS
